...
var tenapps = {
 ...
 "uz","va","vc","ve","vg","vi","vn","vu","wf","ws","ye","yt","za","zm","zw","cw","sx","bl","mf","eh","ss","um","xk"];
...
ccsdiv=ccsdiv.sort();  // console.log("ccsdiv sorted: ",ccsdiv.length,JSON.stringify(ccsdiv)); //  248 ccs
...
var cont_val = {"lng":"nap","geo":"wrld","app":"kyx/ini","list":"cont/vals","vals":{  //  "ttags":"wrld cont part vals",
  "afri":{"north":["DZ","EG","EH","LY","MA","SD","TN"],
          "west" :["BF","BJ","CI","CV","GH","GM","GN","GW","LR","ML","MR","NE","NG","SL","SN","TG"],
...
var contdiv =
[{"lng":"nap","geo":"afri/north","app":"kyx/ini","list":"cont/part","divs":["DZ","EG","EH","LY","MA","SD","TN"]},
 {"lng":"nap","geo":"afri/west", "app":"kyx/ini","list":"cont/part","divs":["BF","BJ","CI","CV","GH","GM","GN","GW","LR","ML","MR","NE","NG","SL","SN","TG"]},
 {"lng":"nap","geo":"afri/centr","app":"kyx/ini","list":"cont/part","divs":["AO","CD","CF","CG","CM","GA","GQ","SS","ST","TD"]},
 {"lng":"nap","geo":"afri/east", "app":"kyx/ini","list":"cont/part","divs":["BI","DJ","ER","ET","IO","KE","KM","MG","MU","MW","MZ","RE","RW","SO","SC","TZ","UG","YT","ZM","ZW"]},
 {"lng":"nap","geo":"afri/south","app":"kyx/ini","list":"cont/part","divs":["BW","LS","NA","SZ","ZA"]},
 {"lng":"nap","geo":"amer/north","app":"kyx/ini","list":"cont/part","divs":["BM","CA","GL","PM","UM","US"]},
 {"lng":"nap","geo":"amer/centr","app":"kyx/ini","list":"cont/part","divs":["BZ","CR","GT","HN","MX","NI","PA","SV"]},
 {"lng":"nap","geo":"amer/carib","app":"kyx/ini","list":"cont/part","divs":["AI","AG","AW","BB","BL","BS","CU","CW","DM","DO","GD","GP","HT","JM","KN","KY","LC","MF","MS","MQ","PR","SX","TC","TT","VC","VG","VI"]},
 {"lng":"nap","geo":"amer/south","app":"kyx/ini","list":"cont/part","divs":["AR","BO","BR","CL","CO","EC","FK","GF","GS","GY","PE","PY","SR","UY","VE"]},
 {"lng":"nap","geo":"asia/west", "app":"kyx/ini","list":"cont/part","divs":["AE","AM","AZ","BH","GE","IQ","IL","JO","KW","LB","OM","PS","QA","SA","SY","TR","YE"]},
 {"lng":"nap","geo":"asia/centr","app":"kyx/ini","list":"cont/part","divs":["KZ","KG","TJ","TM","UZ"]},
 {"lng":"nap","geo":"asia/east", "app":"kyx/ini","list":"cont/part","divs":["CN","HK","JP","KR","MO","MN","KP","TW"]},
 {"lng":"nap","geo":"asia/south","app":"kyx/ini","list":"cont/part","divs":["AF","BD","BT","IN","IR","LK","MV","NP","PK"]},
 {"lng":"nap","geo":"asia/seast","app":"kyx/ini","list":"cont/part","divs":["BN","ID","KH","LA","MM","MY","PH","SG","TH","TL","VN"]},
 {"lng":"nap","geo":"euro/north","app":"kyx/ini","list":"cont/part","divs":["AX","DK","EE","FI","FO","GB","GG","IE","IM","IS","JE","LT","LV","NO","SE","SJ"]},
 {"lng":"nap","geo":"euro/west", "app":"kyx/ini","list":"cont/part","divs":["AT","BE","CH","DE","FR","LI","LU","MC","NL"]},
 {"lng":"nap","geo":"euro/east", "app":"kyx/ini","list":"cont/part","divs":["BG","BY","CY","CZ","HU","MD","PL","RO","RU","SK","UA","XK"]},
 {"lng":"nap","geo":"euro/south","app":"kyx/ini","list":"cont/part","divs":["AD","AL","BA","ES","GI","GR","HR","IT","ME","MK","MT","PT","SI","SM","RS","VA"]},
 {"lng":"nap","geo":"ocea/austnz", "app":"kyx/ini","list":"cont/part","divs":["AU","CC","CX","NF","NZ"]},
 {"lng":"nap","geo":"ocea/melanesia", "app":"kyx/ini","list":"cont/part","divs":["FJ","NC","PG","SB","VU"]},
 {"lng":"nap","geo":"ocea/polynesia", "app":"kyx/ini","list":"cont/part","divs":["AS","CK","NU","PF","PN","TK","TO","TV","WF","WS"]},
 {"lng":"nap","geo":"ocea/micronesia","app":"kyx/ini","list":"cont/part","divs":["FM","GU","KI","MH","MP","NR","PW"]},
 {"lng":"nap","geo":"antartica/nap","app":"kyx/ini","list":"cont/part","divs":["AQ","BV","HM","TF"]}
];
...
var euronoeu = {"lng":"nap","geo":"euro/noeu","app":"kyx/ini","list":"cont/noeu","divs":[]};
 ...
 var ccs_div = {"lng":"nap","geo":"nap","app":"kyx/ini", "list":"ccs/div",    "divs":[]}; ccs_div.divs = ccsdiv;
 var lng_div = {"lng":"nap","geo":"nap","app":"kyx/ini", "list":"lng/div",    "divs":[]}; lng_div.divs = lngdiv.sort();
...
kyxini.lngccs = lng_ccs.vals; // console.log("lng_ccs.vals: ",lng_ccs.vals); // {ita:['IT','CH','SM','VA'],...}
 ...
 var countcc; var lngn = [], lngt = []; //var xc2;
// kyxini.ccsnat = kyxini.lstobj(kyxini.ccsdiv,{});  // create country list filter ccsdiv
...
console.log("kyxini.rus): ",JSON.stringify(kyxini.rus)); //  'eng','spa','fra','deu','nld','fin','ita','por','rus','jpn','hrv','cym'

console.log("kyxini.nat.ccs_com: ",kyxini.nat.ccs_com);
...
//    {"lng":"nap","geo":"es/an","app":"kyx/ini","list":"HASC","zone":"adm1","url":"","mapa":{},"divs":[]} // divs from statoids HASC
var ccx = {"lng":"nap","geo":"ES","app":"kyx/ini","list":"ccs","zone":"adm0","divs":[],"mapa":{},// "mapa":{"type":"MultiPolygon","coordinates":[]}
          "dat":{"lngs":[],"dial":[],"divlng":{},"ppl":{},"area":0,"cont":"","bord":[],"lock":"","latlng":[],
                   "url":"","curr":[],"post":"","fon":"","tld":[],"iso":"","cca3":"","cioc":"","ccn3":"","alts":[] } } // "axie":"","ttag":"",
//                 "eng":{"com":"","ofi":"","dem":"","cap":"","adm":[""]}}

kyxini.ccsdiv.forEach((cc)=>{kyxwrld[cc]=JSON.parse(JSON.stringify(ccx))});
countriesqp.forEach((xdat)=>{ var ck = xdat.cca2;
                              kyxwrld[ck].geo = xdat.cca2;
...
console.log("kyxwrld.US : ",kyxwrld.US);

var wrld_com= {"lng":"eng","geo":"wrld",  "app":"kyx/ini","list":"ccs/com", "vals":{}} // /ofi /dem /cap
var filter={"lng":"nap","geo":"cont/part","app":"kyx/ini","list":"euro/south"} // >> "divs":[] // filter
var appcod={"lng":"nap","geo":"nap","app":"kyx/srx","jss":"","jsc":"","htm":"","css":""} //  ,"url":"","ttag":[]
var applbl={"lng":"spa","geo":"nap","app":"kyx/srx","list":"kyx/srx",    "vals":{},"axie":["sys/FNF"], "wrds":["Archivo no encontrado"]}

var appdat={"lng":"spa","geo":"nap","app":"axs|geo|sys|bok|lrn","paxie":"lion","axie":"أسد","wrds":"león","ttag":"animal wild","mapa":{}}  // "mapa":{points}
var appdat={"lng":"spa","geo":"nap","app":"srx",    "list":"animal/wild","vals":{},"axie":["lion"],"wrds":["león"]} // "tree":"lng/root,lng/name,app/kyx"
var appdox={"tim":"","geo":"nap","lng":"nap","app":"nap","owner":"pub","doc":{},"ttag":"animal wild lion"}
var appdat={"lng":"spa","geo":"es", "app":"kyx/account", "owner":"usr","doc":{}}
// "tree":"lng/root,lng/name,app/kyx" // app: axs->thesaurus geo->hasc   // sector: coran proverbios medicina farmacia
//ٱلۡحَمۡدُ لِلَّهِ رَبِّ ٱلۡعَـٰلَمِينَ (﻿٢﻿)

var ini1=  {"lng":"nap,ini,nat,spa","geo":"nap,ini,wrld,es,es/an",    "axie":["an"],"wrds":["Andalucía"],
            "list":"divs,lngs,lngs/ccs,ccs/lngs,ccs/eurocom,adm,cont,cont/part,ccs/com,ccs/ofi,ccs/dem,ccs/cap,animal/wild"}
//
...
//var ling={"lng":"zgh","geo":"lng","divs":$lng/ccs,"mapa":$zgh.json,"sector":["basic"],"auth":"IRCAM","url":"http://zgh.ircam.ma/api"}

// Validation: georeference -> HASC:cc.rr.pp.vv -> {"cc":{"rr":{"pp":{"vv":{}}}}}} -> cc.pp.divs
//                                              "geo":"es/an","divs":["se","ma"],"mapa":{}
// Validation: axireference -> "lng":"spa","axie":"geo:es/an",    "ttag":"es/an","wrd":"Andalucía", list
// Validation: axireference -> "lng":"spa","axie":"geo/es/an/div","ttag":"es/an","list":"geo/es/an/div","vals":{"se":"Sevilla","ma":"Málaga"},
// Validation: lngreference -> lng paxie wrd regs mapa
/*
{"evt":
[
  "urt":"http://event_transaction_target","own":"owner_id",
  "dts":"date_time_stamp","gps":"[lat,long]","gtg":"geotag es/an",
  "doc":"form|IoTcmd|file.ext"
  "ttag":""
]
*/
