...
RUN ["/bin/bash", "-c",  "set -ex; \
  ...
  gpg2 --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys DD8F2338BAE7501E3DD5AC78C273792F7D83545D; \
gpg2 --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8; \
gpg2 --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 56730D5401028683275BD23C23EFEFE93C4CFFFE; \
gpg2 --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys FD3A5288F042B6850C66B31F09FE44734EB7990E; \
gpg2 --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys B9AE9905FFD7803F25714661B63B535A4C206CA9; \
